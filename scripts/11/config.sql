...
sudo mv /var/lib/postgresql/18/main /var/lib/postgresql/18/maintest
-- sudo mv /var/lib/postgresql/18/maintest /var/lib/postgresql/18/main

-- errors
sudo pg_ctlcluster 18 main start
sudo pg_ctlcluster 18 main start -D /var/lib/postgresql/18/maintest
...
SELECT * FROM pg_file_settings WHERE sourcefile='/var/lib/postgresql/18/main/postgresql.auto.conf';
